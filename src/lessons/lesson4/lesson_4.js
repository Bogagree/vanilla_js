...
const promise = new Promise((res, rej) => {
    ...
    // промис находиться в состоянии pending потому что ничего не возвращает, т.е. он
})
...
const promise3 = new Promise((res, rej) => {
    // throw new Error("error with throw")
    rej(new Error, console.log("Promise Error"))
})
...
const handlePromise = {
    ...
    resolve: null,
    reject: null,
    onSuccess: (success) => console.log(`Promise is resolved with data: ${success}`),
